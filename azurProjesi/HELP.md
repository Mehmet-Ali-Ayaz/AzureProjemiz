...
* The following dependencies are not known to work with Spring Native: 'Spring Session, Spring Web Services, MS SQL Server Driver'. As a result, your application may not work as expected.
